...
import com.c2a.gestionventes.service.impl.AuthServiceImpl;
...
class AuthController {
    ...
    public ResponseEntity<Void> registerClient(@Valid @RequestBody AuthDTOs.ClientRegisterRequest request) {
